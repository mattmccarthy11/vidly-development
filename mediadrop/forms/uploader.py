...
class UploadForm(ListForm):
    ...
    class fields(WidgetsList):
        ...
        email = TextField(validator=email_validator(not_empty=True), label_text=N_('Your Email:'), help_text=N_(''), maxlength=255)
        ...
        file = FileField(validator=FieldStorageUploadConverter(if_missing=None, messages={'empty':N_('Oops! You forgot to enter a file.')}), label_text=N_('OR:'), css_classes=['file'])
        submit = SubmitButton(default=N_('Submit'), css_classes=['btn'])